...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Actions socio-éducatives pour accompagner les jeunes vers l'autonomie"}],"link":[{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,400;0,500;0,600;1,400;1,500;1,600&display=swap"}],"style":[],"script":[],"noscript":[],"title":"Prado Itinéraires","htmlAttrs":{"lang":"fr"}};
